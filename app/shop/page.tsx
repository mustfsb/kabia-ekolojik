        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p className="text-xl md:text-2xl text-muted-foreground dark:text-gray-400 mb-12">
              Ekolojik tarım ürünlerimiz, doğal kozmetik ve ev ürünlerimiz çok yakında online mağazamızda satışa
              sunulacak.
            </p>
          </motion.div>
          ...
          >
            <div className="bg-[#5A9D4B]/10 dark:bg-[#7ED957]/20 p-4 rounded-full">
              <ShoppingBag className="h-12 w-12 text-[#5A9D4B] dark:text-[#7ED957]" />
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground dark:text-gray-400 mb-6">
              Mağazamız açıldığında ve yeni ürünlerimiz eklendiğinde haberdar olmak için e-posta adresinizi bırakın.
            </p>
          ...
          >
            <div className="bg-gradient-to-br from-[#F7FAF5] to-white dark:from-[#1A2718] dark:to-[#243020] p-6 rounded-xl border border-[#E8F4E5] dark:border-[#3A6D2B]/50 shadow-sm">
              <h3 className="text-lg font-semibold mb-2 text-[#5A9D4B] dark:text-[#7ED957]">Organik Gıdalar</h3>
              <p className="text-muted-foreground dark:text-gray-400 mb-4">
                Kendi çiftliğimizde yetiştirdiğimiz organik sebze, meyve ve diğer gıda ürünleri.
              </p>
            ...
            <div className="bg-gradient-to-br from-[#F7FAF5] to-white dark:from-[#1A2718] dark:to-[#243020] p-6 rounded-xl border border-[#E8F4E5] dark:border-[#3A6D2B]/50 shadow-sm">
              <h3 className="text-lg font-semibold mb-2 text-[#5A9D4B] dark:text-[#7ED957]">Doğal Kozmetik</h3>
              <p className="text-muted-foreground dark:text-gray-400 mb-4">
                Kimyasal içermeyen, doğal malzemelerden üretilmiş cilt bakım ve kozmetik ürünleri.
              </p>
              <div className="text-[#5A9D4B] dark:text-[#7ED957] font-medium flex items-center">
                Yakında <ArrowRight className="ml-1 h-4 w-4" />
              </div>
            ...
            <div className="bg-gradient-to-br from-[#F7FAF5] to-white dark:from-[#1A2718] dark:to-[#243020] p-6 rounded-xl border border-[#E8F4E5] dark:border-[#3A6D2B]/50 shadow-sm">
              <h3 className="text-lg font-semibold mb-2 text-[#5A9D4B] dark:text-[#7ED957]">Ev Ürünleri</h3>
              <p className="text-muted-foreground dark:text-gray-400 mb-4">
                Sürdürülebilir malzemelerden üretilmiş, çevre dostu ev ve yaşam ürünleri.
              </p>
              <div className="text-[#5A9D4B] dark:text-[#7ED957] font-medium flex items-center">
                Yakında <ArrowRight className="ml-1 h-4 w-4" />
              </div>
